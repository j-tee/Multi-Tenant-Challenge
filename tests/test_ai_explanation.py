...
class TestAIExplanation:
    ...
    def test_explanation_fallback_without_ai(
        ...
        tx_response = client.get(f"/tenants/{sample_tenant['id']}/bank-transactions")
    ...
    def test_explanation_contains_relevant_info(
        self, client, sample_tenant, sample_vendor, sample_invoice, sample_bank_transactions
    ):
    ...
    def test_explanation_invalid_invoice(self, client, sample_tenant, sample_bank_transactions):
    ...
    def test_explanation_invalid_transaction(self, client, sample_tenant, sample_invoice):
    ...
    def test_explanation_tenant_isolation(
        ...
        other_tenant_response = client.post("/tenants", json={"name": "Other Tenant"})
...
class TestAIExplanationMocked:
    ...
    def test_explanation_with_mocked_ai(
        self, client, sample_tenant, sample_vendor, sample_invoice, sample_bank_transactions
    ):
    ...
    def test_explanation_ai_error_fallback(
        self, client, sample_tenant, sample_vendor, sample_invoice, sample_bank_transactions
    ):
